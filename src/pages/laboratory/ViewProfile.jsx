...
import { FiMail, FiPhone, FiMapPin, FiUser, FiAward, FiCheckCircle } from "react-icons/fi";
import DashboardLayout from "../../layouts/DashboardLayout";

export default function ViewProfile() {
  const laboratory = {
    name: localStorage.getItem("userName") || "CureVirtual Laboratory",

    email: localStorage.getItem("email") || "lab@example.com",
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-6 mb-10">
            ...
            <div className="flex-1">
              <div className="flex flex-wrap items-center gap-3 mb-3">
                <h2 className="text-3xl font-black text-[var(--text-main)]">{laboratory.name}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-3xl p-6 flex items-start gap-4">
              ...
              <div>
                ...
                <h3 className="font-bold text-sm text-[var(--text-main)]">{laboratory.email}</h3>
              </div>
            </div>
            ...
            <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-3xl p-6 flex items-start gap-4">
              ...
              <div>
                ...
                <h3 className="font-bold text-sm text-[var(--text-main)]">{laboratory.phone}</h3>
              </div>
            </div>
            ...
            <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-3xl p-6 flex items-start gap-4">
              ...
              <div>
                ...
                <h3 className="font-bold text-sm text-[var(--text-main)]">{laboratory.address}</h3>
              </div>
            </div>
            ...
            <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-3xl p-6 flex items-start gap-4">
              ...
              <div>
                ...
                <h3 className="font-bold text-sm text-[var(--text-main)]">{laboratory.joined}</h3>
              </div>
            </div>
          </div>
        </div>
